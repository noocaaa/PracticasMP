...
${TESTDIR}/tests/10.Integration_DataVector.o: tests/10.Integration_DataVector.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__RELEASE__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_DataVector.o tests/10.Integration_DataVector.cpp
